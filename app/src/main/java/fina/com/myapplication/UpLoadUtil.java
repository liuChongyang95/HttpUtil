...
public class UpLoadUtil {
     ...
     * Android上传文件到服务端
     *
     * HTTP 状态行 请求头headers中设置content-type规定消息编码格式 消息主体entity body
     *
     * @param file       需要上传的文件
    ...
    public static String uploadFile(File file, String RequestURL) {
        String result = null;
        String BOUNDARY = UUID.randomUUID().toString();// 边界标识 随机生成---------------------------7db372eb000e2类似形式 用来分割多个文件，表单
        ...
        try {
            ...
            if (file != null) {
                ...
                sb.append("Content-Type: application/octet-stream; charset=" + CHARSET + LINE_END);// content-type::::内容类型可能是？audio/mp3*******************
                sb.append(LINE_END);
